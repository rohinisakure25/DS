...
words_to_lemma = ["running", "better", "studies", "feet"]

lemmatized_words = [lemmatizer.lemmatize(w) for w in words_to_lemma]

print("\n----- Lemmatization Results -----")
print(dict(zip(words_to_lemma, lemmatized_words)))
